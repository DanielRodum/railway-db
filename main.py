...
con = sqlite3.connect("ProsjektDB.db") #File was deleted after the delivery of the project, but the functionality should still be clear from viewing the code below
cursor = con.cursor()
